...
* **Test Naming:** Use the `test_<what>_<when>_<expected>` convention (e.g., `test_arbitrate_low_confidence_returns_escalated`).
* **Coverage:** Target 80%+ minimum. Run with `pytest --cov=src --cov-report=term-missing -v`.
